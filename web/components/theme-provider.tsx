...
const themeConfigs: Record<ThemeName, ThemeDef> = {
  "blue-white": {
    ...
    cssVars: {
      ...
      "--tag-style": "flat",
      "--body-bg": "radial-gradient(circle at top left, rgba(59, 130, 246, 0.12), transparent 30%), radial-gradient(circle at top right, rgba(14, 165, 233, 0.1), transparent 28%), linear-gradient(180deg, #fbfdff 0%, #f4f7fb 48%, #eef2f7 100%)",
      "--shell-bg": "radial-gradient(circle at top left, rgba(59, 130, 246, 0.06), transparent 22%), radial-gradient(circle at bottom right, rgba(16, 185, 129, 0.05), transparent 24%)",
      "--topbar-bg": "rgba(255, 255, 255, 0.72)",
      "--hero-bg": "linear-gradient(135deg, rgba(59, 130, 246, 0.08), rgba(255, 255, 255, 0.96)), rgba(255, 255, 255, 0.96)",
      "--hero-decorator": "rgba(59, 130, 246, 0.12)",
      "--empty-bg": "linear-gradient(180deg, rgba(255, 255, 255, 0.88), rgba(248, 250, 252, 0.98)), rgba(255, 255, 255, 0.94)",
      "--card-inner-bg": "linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(248, 250, 252, 0.98))",
      ...
      "--card-preview-bg": "rgba(255, 255, 255, 0.62)",
  ...
  "black-gold": {
    ...
    cssVars: {
      ...
      "--font-weight-body": "400",
      "--tag-style": "flat",
      "--body-bg": "radial-gradient(circle at top left, rgba(212, 168, 83, 0.08), transparent 30%), radial-gradient(circle at top right, rgba(180, 140, 60, 0.06), transparent 28%), linear-gradient(180deg, #0d0d0d 0%, #111111 48%, #0a0a0a 100%)",
      "--shell-bg": "radial-gradient(circle at top left, rgba(212, 168, 83, 0.04), transparent 22%), radial-gradient(circle at bottom right, rgba(180, 140, 60, 0.03), transparent 24%)",
      "--topbar-bg": "rgba(13, 13, 13, 0.85)",
      "--hero-bg": "linear-gradient(135deg, rgba(212, 168, 83, 0.08), rgba(26, 26, 26, 0.96)), rgba(26, 26, 26, 0.96)",
      "--hero-decorator": "rgba(212, 168, 83, 0.12)",
      "--empty-bg": "linear-gradient(180deg, rgba(26, 26, 26, 0.88), rgba(18, 18, 18, 0.98)), rgba(26, 26, 26, 0.94)",
      "--card-inner-bg": "linear-gradient(180deg, rgba(26, 26, 26, 0.98), rgba(20, 20, 20, 0.98))",
      ...
      "--card-preview-bg": "rgba(26, 26, 26, 0.62)",
  ...
  "pink": {
    ...
    cssVars: {
      ...
      "--font-weight-body": "400",
      "--tag-style": "pill",
      "--body-bg": "radial-gradient(circle at top left, rgba(232, 67, 147, 0.1), transparent 30%), radial-gradient(circle at top right, rgba(240, 98, 146, 0.08), transparent 28%), linear-gradient(180deg, #fef6fb 0%, #fce4ec 48%, #fff0f5 100%)",
      "--shell-bg": "radial-gradient(circle at top left, rgba(232, 67, 147, 0.05), transparent 22%), radial-gradient(circle at bottom right, rgba(253, 121, 168, 0.04), transparent 24%)",
      "--topbar-bg": "rgba(255, 255, 255, 0.72)",
      "--hero-bg": "linear-gradient(135deg, rgba(232, 67, 147, 0.06), rgba(255, 255, 255, 0.96)), rgba(255, 255, 255, 0.96)",
      "--hero-decorator": "rgba(232, 67, 147, 0.1)",
      "--empty-bg": "linear-gradient(180deg, rgba(255, 255, 255, 0.88), rgba(254, 246, 251, 0.98)), rgba(255, 255, 255, 0.94)",
      "--card-inner-bg": "linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(254, 246, 251, 0.98))",

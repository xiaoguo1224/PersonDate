...
export default function WechatStatusPage() {
  ...
  const summaryCards = useMemo(() => {
    ...
    return [
      ...
      { label: "排队出站", value: data.queued_outbound_messages, color: "blue" },
      { label: "已发送", value: data.sent_outbound_messages, color: "green" },
      { label: "发送失败", value: data.failed_outbound_messages, color: "red" },
